...
public class TestBase {
  ...
  private void loginWeb(String username, String password) {
  ...
  protected void returnToGroupPage(By groups, By logout) {
  ...
  protected void deleteSelectGroup(String delete) {
